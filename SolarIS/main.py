...
def simulation_result():
    ...
    d_annual_mean = pd.read_csv('annual_mean.csv', engine='python')
    ...
    d_annual_table = pd.read_csv('annual_table.csv', engine='python')
...
def get_product_list():
    df = pd.read_csv('salse_company.csv', encoding='EUC-KR')
    html_str = ''
...
def check():
    ...
    if int(result):  # id pw 일치 시
        ...
        df2 = pd.read_csv("monitoring_anorm.csv")
        ...
        df_day = pd.read_csv("monitoring_day_fin.csv")
        ...
        df_mon = pd.read_csv("monitoring_month.csv")
